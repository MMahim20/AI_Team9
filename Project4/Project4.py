...
# Train the cycleGAN
    ...
    model_path = "Project4/model/cycleGAN.h5"
   

    if os.path.exists(model_path):

         # Call the model with some dummy input to build its layers
        dummy_input = tf.ones((1, 256, 256, 3))  # Adjust shape as needed
        cycle_gan_model(dummy_input)
    ...
    try:
        ...
        cycle_gan_model.save_weights(model_path)
